...
export function ContactSection() {
  ...
  return (
    <section id="contact" ref={sectionRef} className="relative py-24 sm:py-32 bg-background">
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          >
            <div className="space-y-6">
              <h3 className="text-xl font-semibold text-foreground">Ask us anything</h3>
              <p className="text-muted-foreground">
                {
                  "Are you a company seeking consulting services, a dealership looking to optimize operations, or simply interested in what we're building? Let's connect."
                }
              </p>
            ...
            <div className="space-y-4">
              ...
              {offices.map((office, index) => (
                <div
                  key={office.name}
                  className={cn(
                    "p-4 rounded-xl bg-card border border-border hover:border-primary/50 transition-all duration-300",
                    isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10",
                  )}
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6 p-8 rounded-2xl bg-card border border-border">
              ...
              <Button
                type="submit"
                className="w-full bg-primary text-primary-foreground hover:bg-primary/90 transition-all duration-300 hover:shadow-lg hover:shadow-primary/25 group"
              >
                Send Message
